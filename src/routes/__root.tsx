...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Buchex Impex Concept — Premium Granite & Marble Solutions in Enugu" },
      { name: "description", content: "Buchex Impex Concept delivers premium granite and marble installations for kitchens, staircases, bathrooms and commercial spaces in Enugu, Nigeria." },
      { name: "author", content: "Buchex Impex Concept" },
    ...
    links: [
      { rel: "preconnect", href: "https://fonts.googleapis.com" },
       { rel: "icon", href: myLogo, sizes: "any"},
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&family=Poppins:wght@500;600;700;800&display=swap" },
        { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Lobster:wght@400;500;600;700&family=Poppins:wght@500;600;700;800&display=swap" },
